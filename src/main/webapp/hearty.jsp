...
<%@ page import="com.google.glassware.FakeDatabase" %>
...
<div class="container">
  ...
  <% } %>
    ...
    <h1><img width="60px" src="<%= appBaseUrl + "static/images/color_icon_120.png" %>">Hearty Data</h1>
      <div class="row">
    ...
    <div style="margin-top: 5px;">
        ...
        <div class="span4">
          <form action="<%= WebUtil.buildUrl(request, "/hearty") %>" method="post">
